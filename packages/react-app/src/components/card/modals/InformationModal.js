...
import {Box, Divider, easing, Fade, Modal, Paper, Slide, Stack, Typography} from '@mui/material'
...
const InformationModal = ({ open, onClose, frame }) => {
	...
	const InformationContent = (
		<Stack display="flex" height={'100%'} spacing={2} flexDirection="column" alignItems="center" justifyContent="center" width="240px">
			...
			<Button onClick={() => chooseAction('improve-frame')} fullWidth color="primary" variant="contained">Improve Frame</Button>
			<Button onClick={() => chooseAction('train')} fullWidth color="primary" variant="contained">Train</Button>
			<Button onClick={() => chooseAction('sell')} fullWidth color="secondary" variant="contained" my={4}>Sell</Button>
			<Divider flexItem color="primary" />
	...
	const LayoutContent = forwardRef(({children, name}, ref) => (
		<Stack ref={ref} display="flex" height={'100%'} spacing={2} flexDirection="column" alignItems="center" justifyContent="center" width="240px">
